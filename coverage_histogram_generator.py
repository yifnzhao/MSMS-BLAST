...
def gene_dic_with_MS(gene_dic, unique_csv_dir):
    ...
    for entry in mylist:
        ...
        #                   ]}
    numENST_MS=numENST=0
    for k,v in gene_dic_with_MS.items():
       numENST_MS+=len(v[1])
       numENST+=len(v[0])
       
    print("numENST is: ", numENST)
    print("numENST_MS is: ", numENST_MS)
...
#            print(coverage)
    ...
    data.plot.hist(grid=True, color = 'grey', rwidth=1, bins=25)
...
if __name__=="__main__":
    #os.chdir("/Users/yifan/BIOC396/MSMS_BLAST/data_summary/")
    gene_count_dic=gene_transcript_dic('/Users/yifan/BIOC396/MSMS_BLAST/data_summary/supp_table/supp_table_5-getpra_comparison.csv')
    enst_count_list=enst_count_histogram(gene_count_dic)
    gene_count_dic_with_MS=gene_dic_with_MS(gene_count_dic, '/Users/yifan/BIOC396/MSMS_BLAST/data_summary/supp_table/supp_table_4-getpra_comparison_unique.csv')
